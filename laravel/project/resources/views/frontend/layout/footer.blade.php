 <!-- Footer Start -->
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="row mx-n1">
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="{{url('frontend/img/gallery-1.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="{{url('frontend/img/gallery-2.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="{{url('frontend/img/gallery-3.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="{{url('frontend/img/gallery-4.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="{{url('frontend/img/gallery-5.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="{{url('frontend/img/gallery-6.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
    ...
    <div class="container-fluid bg-dark py-4 px-sm-3 px-md-5">
        ...
        <p class="m-0 text-center text-body">Designed by <a href="#">Tops Technologies</a></p>
    </div>
    <!-- Footer End -->
